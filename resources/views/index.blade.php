<x-app-layout>
    <div class="filters flex space-x-6">
        ...
        <div class="w-2/3 relative">
            <input type="search" class="w-full rounded-xl bg-white border-none px-4 py-2 pl-8 placeholder-gray-900"
    ...
    <div class="ideas-container space-y-6 my-6">
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            <button
                                ...
                                <ul
                                    ...
                                    <li><a href="#"
                                            class="hover:bg-gray-100 block transition duration-150 ease-in px-5 py-3">Mark as Spam</a></li>
                                    <li><a href="#"
                                            class="hover:bg-gray-100 block transition duration-150 ease-in px-5 py-3">Delete Post</a></li>
                                </ul>
                            </button>
                        </div>
                    </div>
        ...
        <div
            class="idea-container is-admin hover:shadow-card transition duration-150 ease-in bg-white rounded-xl flex cursor-pointer">
            <div class="border-r border-gray-100 px-5 py-8">
                <div class="text-center">
