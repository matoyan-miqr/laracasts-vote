<x-app-layout>
  <div class="filters flex space-x-6">
    ...
    <div class="w-2/3 relative">
      <input type="search" class="w-full rounded-xl bg-white border-none px-4 py-2 pl-8 placeholder-gray-900" placeholder="Find an Idea"> 
  ...
  <div class="ideas-container space-y-6 my-6">
    ...
    <div class="idea-container is-admin hover:shadow-card transition duration-150 ease-in bg-white rounded-xl flex cursor-pointer">
        <div class="border-r border-gray-100 px-5 py-8">
            <div class="text-center">
