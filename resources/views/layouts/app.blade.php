...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans text-gray-900 bg-gray-background text-sm">
      ...
      <main class="container mx-auto max-w-cutom flex">
        <div  class="w-70 mr-5">
          <div class="border-2 border-blue bg-white rounded-xl mt-16"
          style="
    ...
    "
          >
            ...
            <form action="#" method="POST" class="space-y-4 px-4 my-6">
              <div>
              ...
              <div>
                <textarea name="idea" id="idea" cols="30" rows="4" class="w-full bg-gray-100 text-sm placeholder-gray-900 rounded-xl border-none px-4 py-2" placeholder="Describe your idea"></textarea>
              </div>
              <div class="flex items-center justifiy-between space-x-3">
                <button 
                  type="button"
                  class="flex item-center justify-center w-1/2 h-11 text-my bg-gray-200 font-semibold rounded-xl border border-gray-200 hover:border-gray-400 transistion duration-150 ease-in px-6 py-3"
                  >
                ...
                <button 
                  type="submit"
                  class="flex item-center justify-center w-1/2 h-11 text-my bg-blue font-semibold text-white rounded-xl border border-blue hover:bg-blue-hover transistion duration-150 ease-in px-6 py-3"
                  >
